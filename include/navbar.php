...
if ($is_logged_in) {
    ...
    if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
        ...
        try {
            ...
            log_message("Database query failed for role check in navbar: {$e->getMessage()}, public_key: $short_public_key", 'bootstrap.log', 'logs', 'ERROR');
        }
    }
}
?>
    ...
    <ul class="navbar-content">
        ...
        <li class="navbar-item dropdown">
            ...
            <ul class="dropdown-menu">
                <?php if ($is_admin): ?>
                    <li><a href="/manage/list-users" class="dropdown-link"><i class="fas fa-user-shield"></i> List Users</a></li>
                <?php endif; ?>
