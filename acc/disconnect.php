...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    log_message("Invalid disconnect request: Not POST, IP=" . ($_SERVER['REMOTE_ADDR'] ?? 'unknown'), 'accounts.log', 'accounts', 'ERROR');
...
log_message("Disconnect attempt for public_key: $short_public_key, IP=" . ($_SERVER['REMOTE_ADDR'] ?? 'unknown'), 'accounts.log', 'accounts', 'INFO');
