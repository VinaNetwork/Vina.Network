<?php
// ============================================================================
// File: acc/login/connect-p.php
// Description: Connect Phantom Wallet to Vina Network.
...
if (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) {
    ...
    if (strpos($referrer, '/mm/create-process') === 0 || strpos($referrer, '/other-protected-page') === 0) {
...
$page_css = ['/acc/login/connect-p.css'];
?>
...
<script src="/acc/login/connect-p.js"></script>
</body>
</html>
<?php ob_end_flush(); ?>
