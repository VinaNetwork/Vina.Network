// ============================================================================
// File: acc/connect-phantom/connect-p.js
// Description: Script for managing wallet connection
// Created by: Vina Network
// ============================================================================

document.addEventListener('DOMContentLoaded', () => {
    console.log('connect-p.js loaded');
    log_message('connect-p.js loaded', 'accounts.log', 'accounts', 'DEBUG');
