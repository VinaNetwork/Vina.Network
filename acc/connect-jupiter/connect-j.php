<?php
// ============================================================================
// File: acc/connect-jupiter/connect-j.php
// Description: Connect Jupiter Wallet to Vina Network.
...
// SEO meta
$page_title = "Connect Jupiter Wallet to Vina Network";
$page_description = "Connect your Solana wallet to register or login to Vina Network";
$page_keywords = "Vina Network, connect wallet, login, register, Jupiter";
$page_url = BASE_URL . "connect-j";
$page_css = ['/acc/connect-jupiter/connect-j.css'];
?>
...
<div class="acc-container">
    <div class="acc-content">
        <h1>Connect to Vina Network with Jupiter Wallet</h1>
...
<script src="/acc/connect-jupiter/connect-j.js?t=<?php echo time(); ?>" onerror="console.error('Failed to load /connect-jupiter/connect-j.js')"></script>
</body>
</html>
<?php ob_end_flush(); ?>
