...
log_message("get-csrf.php started, REQUEST_METHOD: {$_SERVER['REQUEST_METHOD']}, REQUEST_URI: {$_SERVER['REQUEST_URI']}", 'make-market.log', 'auth', 'DEBUG');

initialize_auth();
if (!check_user_auth()) {
    log_message("check_user_auth failed, exiting", 'make-market.log', 'auth', 'ERROR');
