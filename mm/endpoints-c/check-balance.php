<?php
// ============================================================================
// File: mm/endpoints-c/check-balance.php
// Description: Check wallet balance for SOL and Token.
...
try {
    ...
    $transactionFee = defined('TRANSACTION_FEE') ? TRANSACTION_FEE : 0.00001; // Fallback to 0.00001 if not defined
