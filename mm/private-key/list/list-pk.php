<?php
// File: mm/private-key/list/list-pk.php
...
// Log request
log_message("list-pk.php: Script started, REQUEST_METHOD: {$_SERVER['REQUEST_METHOD']}", 'private-key-page.log', 'make-market', 'DEBUG');
...
$page_css = ['/mm/private-key/list/list-pk.css'];
?>
...
<div class="mm-container">
	<div class="mm-content">
		...
		<a href="/mm/add-private-key" class="cta-button"><i class="fa-solid fa-plus"></i> Add Private key</a>
