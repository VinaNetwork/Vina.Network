...
<section class="t-1">
    <div class="t-2">
        ...
        <div class="tools-tabs">
            <a href="?tool=nft-holders" class="tab-link <?php echo (isset($_GET['tool']) ? $_GET['tool'] : 'nft-holders') === 'nft-holders' ? 'active' : ''; ?>" data-tool="nft-holders">
            ...
            <a href="?tool=wallet-analysis" class="tab-link <?php echo (isset($_GET['tool']) && $_GET['tool'] === 'wallet-analysis') ? 'active' : ''; ?>" data-tool="wallet-analysis">
