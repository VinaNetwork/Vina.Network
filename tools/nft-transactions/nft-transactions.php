...
<div class="tools-about">
    ...
    <p>This tool allows you to look up transaction history for NFTs that are part of a Merkle Tree structure (compressed NFTs only).</p>
</div>
</div>
